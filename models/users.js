...
//this sets up the format for the database user objects that are submitted through the form
...
UserSchema.pre('save', function (next) {
    ...
    // generate a salt(an additional string of data to help encrypt
...
//compare the password entered(candidatePassowrd) with the one saved on the database
